...
void SignalTest()
{
    ...
    jl::Signal<void> Sig0;
    jl::Signal< int > Sig1;
    jl::Signal< int, float > Sig2;
    jl::Signal< int, float, char > Sig3;
    jl::Signal< int, float, char, const char* > Sig4;
    jl::Signal< int, float, char, const char*, int > Sig5;
    jl::Signal< int, float, char, const char*, int, float > Sig6;
    jl::Signal< int, float, char, const char*, int, float, char > Sig7;
    jl::Signal< int, float, char, const char*, int, float, char, const char* > Sig8;
    ...
    Sig2.Emit( 1, 2.0f );
    Sig3.Emit( 1, 2.0f, 'T' );
    Sig4.Emit( 1, 2.0f, 'T', "Four" );
    Sig5.Emit( 1, 2.0f, 'T', "Four", 5 );
    Sig6.Emit( 1, 2.0f, 'T', "Four", 5, 6.0f );
    Sig7.Emit( 1, 2.0f, 'T', "Four", 5, 6.0f, 'S' );
    Sig8.Emit( 1, 2.0f, 'T', "Four", 5, 6.0f, 'S', "Eight" );
